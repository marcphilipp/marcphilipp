...
_Software Engineer_ · _Open Source Enthusiast_ · _JUnit Team Lead_ · _Conference Speaker_ · _Gradle Expert_ · _Java Champion_

- ✅ Part of the [JUnit team](https://junit.org) for over a decade and its lead since 2016
- 🏗️ Previously Senior Principal Software Engineer at [Gradle](https://gradle.org/)/[Develocity](https://develocity.ai), working on build caching, Test Distribution, and Predictive Test Selection
